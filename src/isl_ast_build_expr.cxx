...
{
  struct isl_extract_mod_data *data = (struct isl_extract_mod_data *)user;
...
{
  struct isl_expr_from_basic_data *data = (struct isl_expr_from_basic_data *)user;
	isl_ast_expr *expr;
...
{
	struct isl_expr_from_set_data *data = (struct isl_expr_from_set_data *)user;
	isl_ast_expr *expr;
...
// {
// 	struct isl_from_pw_aff_data *data = (struct isl_from_pw_aff_data *)user;
// 	isl_ctx *ctx;
